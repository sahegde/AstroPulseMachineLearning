...
public class AstronautHealthDataSet2 {
    ...
    private TimeInterval_ timeInterval;
    @JsonIgnore
     ...
     */
    @JsonProperty("time_interval")
    public TimeInterval_ getTimeInterval() {
        return timeInterval;
    }
     ...
     */
    @JsonProperty("time_interval")
    public void setTimeInterval(TimeInterval_ timeInterval) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AstronautHealthDataSet2) == false) {
            return false;
        }
        AstronautHealthDataSet2 rhs = ((AstronautHealthDataSet2) other);
